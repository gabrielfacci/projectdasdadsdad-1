    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div
          ...
          className="relative w-full max-w-lg bg-gradient-to-b from-[#0d0a14]/90 to-[#0d0a14]/95 backdrop-blur-xl rounded-2xl p-8 border border-[#7B68EE]/20 overflow-hidden"
        >
          ...
          <div className="absolute inset-0">
            ...
            <div
              className="absolute inset-0 bg-gradient-to-r from-[#7B68EE]/10 via-transparent to-[#9370DB]/5 rounded-2xl"
                opacity: [0.5, 0.8, 0.5],
                scale: [1, 1.02, 1],
              }}
                duration: 3,
          ...
          >
            ...
            <div className="flex justify-center mb-8">
              <div
                className="w-20 h-20 bg-gradient-to-tr from-[#7B68EE]/30 to-[#9370DB]/20 rounded-2xl flex items-center justify-center relative"
                  boxShadow: [
            ...
            {/* Content */}
            <div
              className="space-y-5 text-center mb-8"
            >
              <div className="space-y-4">
                ...
                <p className="text-neutral-200 leading-relaxed">
                  ...
                  simulou uma configuração sob medida para seu perfil. O
    ...
    <>
      ...
      {!showPrepPopup && (
        <div className="flex flex-col items-center w-full max-w-md mx-auto px-4 py-6 relative">
          ...
          {walletFound && (
            <div
              className="w-full bg-gradient-to-br from-[#0d0a14]/60 to-[#0d0a14]/40 rounded-xl border border-[#7B68EE]/20 p-3 sm:p-4 mb-4 backdrop-blur-sm relative z-10"
            >
              <div className="mb-3">
              ...
              <div className="relative mb-4">
                <div
                  className="bg-gradient-to-br from-green-500/10 to-emerald-500/5 rounded-xl border border-green-500/20 p-4"
                >
                  ...
                  <div
                    className="px-4 py-3 bg-background/40 rounded-lg mb-4 border border-green-500/10 relative overflow-hidden"
                      backgroundColor: [
                        "rgba(0,0,0,0.2)",
                        "rgba(0,0,0,0.3)",
                        "rgba(0,0,0,0.2)",
              ...
              <div
                className="relative bg-gradient-to-br from-slate-900/40 to-slate-800/30 rounded-2xl border border-emerald-500/20 backdrop-blur-xl overflow-hidden"
              >
                {/* Subtle glow effect */}
              ...
              >
                <button
                  onClick={() => {
                    console.log("Botão clicado - prosseguir para próxima etapa");
                    setShowCompletionModal(true);
                    setIsComplete(true);
                    setMiningStarted(false);
                    setIsStarted(false);
          ...
          <div className="fixed top-4 left-0 right-0 z-50 flex flex-col items-center pointer-events-none">
            <AnimatePresence>
              {notifications.map((notification, index) => (
                ...
                >
                  <div
                    className="absolute inset-0 bg-gradient-to-r from-white/5 via-white/10 to-transparent rounded-xl"
                      opacity: [0.1, 0.3, 0.1],
                        duration: 2,
                        repeat: Infinity,
                        repeatType: "reverse",
          ...
          <p
            className="text-center mt-4 text-neutral-400 text-[13px] relative z-10"
          >
          ...
          <div className="absolute bottom-4 left-4">
            <div
              className="w-2 h-2 rounded-full bg-[#7B68EE]"
                scale: [1, 1.5, 1],
                opacity: [0.7, 1, 0.7],
              }}
                duration: 2,
          ...
          <div className="absolute top-10 right-4">
            <div
              className="w-2 h-2 rounded-full bg-[#9370DB]"
                scale: [1, 1.5, 1],
                opacity: [0.7, 1, 0.7],
              }}
                duration: 2.5,

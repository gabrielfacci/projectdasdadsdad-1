...
import { Cpu, Check, Server, Lightbulb, Activity, Sparkles } from 'lucide-react';
import { useTranslation } from '../../../hooks/useTranslation';
import '../../../index.css';
import './onboardingResponsive.css';

interface MiningExperienceProps {
  onComplete: (experience: string) => void;
}

const MiningExperience: React.FC<MiningExperienceProps> = ({ onComplete }) => {
  ...
  const options = [
    {
      value: "newcomer",
      label: t('onboarding.miningExperience.newcomer.title'),
      description: t('onboarding.miningExperience.newcomer.description'),
      icon: Lightbulb,
      color: '#4ECDC4'
    },
    {
      value: "aware",
      label: t('onboarding.miningExperience.aware.title'),
      description: t('onboarding.miningExperience.aware.description'),
      icon: Activity,
      color: '#FFD166'
    },
    {
      value: "experienced",
      label: t('onboarding.miningExperience.experienced.title'),
      description: t('onboarding.miningExperience.experienced.description'),
      icon: Server,
      color: '#FF6B6B'
    }
  ];
  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        variants={itemVariants}
      >
        {t('onboarding.miningExperience.title')}
      </motion.h2>
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        {t('onboarding.miningExperience.subtitle')}
      </motion.p>
      ...
      {!selectedOption && (
        <motion.div
          ...
          variants={itemVariants}
        >
          <p>{t('onboarding.miningExperience.selectOption')}</p>
        </motion.div>
      )}
...
export default MiningExperience;
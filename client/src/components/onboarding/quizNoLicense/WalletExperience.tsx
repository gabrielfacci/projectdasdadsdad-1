...
import { Wallet, Check, WalletCards, Network, Sparkles } from 'lucide-react';
import { useTranslation } from '../../../hooks/useTranslation';
import '../../../index.css';
import './onboardingResponsive.css';

interface WalletExperienceProps {
  onComplete: (experience: string) => void;
}

const WalletExperience: React.FC<WalletExperienceProps> = ({ onComplete }) => {
  ...
  const options = [
    {
      value: "experienced",
      label: t('onboarding.walletExperience.experienced.title'),
      description: t('onboarding.walletExperience.experienced.description'),
      icon: WalletCards,
      color: '#4ECDC4'
    },
    {
      value: "beginner",
      label: t('onboarding.walletExperience.beginner.title'),
      description: t('onboarding.walletExperience.beginner.description'),
      icon: Wallet,
      color: '#FFD166'
    },
    {
      value: "newcomer",
      label: t('onboarding.walletExperience.newcomer.title'),
      description: t('onboarding.walletExperience.newcomer.description'),
      icon: Network,
      color: '#FF6B6B'
    }
  ];
  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        variants={itemVariants}
      >
        {t('onboarding.walletExperience.title')}
      </motion.h2>
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        {t('onboarding.walletExperience.subtitle')}
      </motion.p>
      ...
      {!selectedOption && (
        <motion.div
          ...
          variants={itemVariants}
        >
          <p>{t('onboarding.walletExperience.selectOption')}</p>
        </motion.div>
      )}

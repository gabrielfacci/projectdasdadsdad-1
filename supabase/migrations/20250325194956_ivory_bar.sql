/*
  ...
  1. Helper Functions
    ...
    - check_user_exists: Check if user exists and get details
    - update_user_profile: Update user profile information
    
  2. License Management
    - validate_all_licenses: Get all licenses for a user
    - update_user_license_status: Update user's license status
    - check_blockchain_access: Check if user has access to blockchain
    - check_turbo_access: Check if user has turbo feature access
    
  3. Referral System
    - get_complete_referral_stats: Get user's referral statistics
    - process_withdrawal: Process referral withdrawal
    - handle_user_operation: Handle user registration/login
*/

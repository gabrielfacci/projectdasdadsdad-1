...
REVOKE ALL ON FUNCTION update_user_license_status_v3(boolean, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION update_user_license_status_v3(boolean, uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION update_user_license_status_v3(boolean, uuid) TO anon;

-- Add helpful comment
COMMENT ON FUNCTION update_user_license_status_v3(boolean, uuid) IS 'Updates a user''s license status with improved parameter validation';
/*
  ...
  1. Changes
    ...
    - Create new policies that allow proper user creation and updates
    - Fix permissions for anonymous and authenticated users
    
  2. Security
    - Maintain security while allowing necessary operations
    - Ensure users can only modify their own data
    - Allow new user creation during onboarding
*/
